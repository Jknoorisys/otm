                ...
                <div class="row">
                    <div class="col-sm-12"><br>
                        <div class="card">
							...
							<div class="col-12">
								<form class="mt-4" action="<?=base_url('manager-requested-ot') ?>" method="POST">
									<div class="row">
										...
										<div class="col-2">
											<div class="form-group m-b-30" style="margin-top: 30px;">
												...
												<a href="<?=base_url('manager-requested-ot') ?>" class="btn btn-secondary">Reset</a>
											</div>
										</div>
											...
											<div class="modal-dialog modal-dialog-centered">
												<div class="modal-content">
													...
													<div class="modal-footer">
														<a href="<?= base_url('manager-requested-ot') ?>" name="cancel" class="btn btn-secondary"><b>Cancel</b></a>
    ...
    $(document).on('click', '#delete', function() {
        ...
        Swal.fire({
			...
			if (result.isConfirmed) {
				$.ajax({
					type: "POST",
					url: "<?= base_url('manager-delete-ot/') ?>"+id,
