                ...
                <div class="row">
                    <div class="col-sm-12"><br>
                        <div class="card">
                            ...
                            <div class="col-12">
								<form class="mt-4" action="<?=base_url('manager-tl-report') ?>" method="POST">
									<div class="row">
										...
										<div class="col-2">
											<div class="form-group m-b-30" style="margin-top: 30px;">
												...
												<a href="<?=base_url('manager-tl-report') ?>" class="btn btn-secondary">Reset</a>
											</div>
										</div>
											...
											<tbody>
												<?php foreach($reports as $report){?>
													<tr>
														...
														<td>
                                                            <form action="<?= base_url('manager-tl-review-details') ?>" method="POST">
