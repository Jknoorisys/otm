                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-md-flex align-items-center">
                                    <div class="container">
                                        <h2 class="card-title" align="center">Accepted OT &nbsp; <span class="badge badge-pill badge-danger"><h3 align="center" style="margin-top: 5px;"><?php foreach($total_hours as $hour){ echo $hour['ot_hours']. " hours";} ?></h3></span></h2>
                                    </div>
                                </div>                                
                            </div>
							<div class="col-12">
								<form class="mt-4" action="<?=base_url('admin-accepted-ot') ?>" method="POST">
									<div class="row">
										...
										<div class="col-2">
											<div class="form-group m-b-30" style="margin-top: 30px;">
												...
												<a href="<?=base_url('admin-accepted-ot') ?>" class="btn btn-secondary">Reset</a>
											</div>
										</div>
