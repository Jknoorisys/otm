            ...
            <div class="card">
                <div class="card-body" align="center">
                    ...
                    <div class="row m-t-40">
                        ...
                        <div class="col-md-6 col-lg-3 col-xlg-3">
                            <div class="card card-hover">
                                <a class="box bg-noori-light bg-noori-light-hover text-center" href="<?= base_url('admin-requested-ot') ?>">
                        ...
                        <div class="col-md-6 col-lg-3 col-xlg-3">
                            <div class="card card-hover">
                                <a class="box bg-noori-light bg-noori-light-hover text-center" href="<?= base_url('admin-accepted-ot') ?>">
                        ...
                        <div class="col-md-6 col-lg-3 col-xlg-3">
                            <div class="card card-hover">
                                <a class="box bg-noori-light bg-noori-light-hover text-center" href="<?= base_url('admin-rejected-ot') ?>">
            ...
            <div class="card">
                <div class="card-body" align="center">
                    ...
                    <div class="row m-t-40">
                        ...
                        <div class="col-md-6 col-lg-3 col-xlg-3">
                            <div class="card card-hover">
                                <a class="box bg-noori-light bg-noori-light-hover text-center" href="<?= base_url('admin-requested-leave') ?>">
                        ...
                        <div class="col-md-6 col-lg-3 col-xlg-3">
                            <div class="card card-hover">
                                <a class="box bg-noori-light bg-noori-light-hover text-center" href="<?= base_url('admin-accepted-leave') ?>">
                        ...
                        <div class="col-md-6 col-lg-3 col-xlg-3">
                            <div class="card card-hover">
                                <a class="box bg-noori-light bg-noori-light-hover text-center" href="<?= base_url('admin-rejected-leave') ?>">
