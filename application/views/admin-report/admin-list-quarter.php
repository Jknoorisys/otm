                                                            ...
                                                            <div class="row justify-content-center">
                                                                ...
                                                                <div class="col-2">
                                                                    <form action="<?= base_url('admin-change-status') ?>" method="POST">
                                                                        ...
                                                                        <button type="submit" data-status="<?= $quarter['status'] == 'active' ? 'active' : 'inactive' ?>" data-id="<?= $quarter['id'] ?>" data-name="<?= $quarter['status'] ?>" class="btn block_confirm btn-sm"><input type="checkbox" id="switch" <?= $quarter['status'] == 'inactive' ? 'checked' : '' ?> /><label class="noori-lable" for="switch">Toggle</label></button>
                                                                    </form>
                                                                </div>
                                                            </div>
                                                        </td>
