    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Add OT Details</h4>
                        <form class="mt-4" action="<?= base_url('User/add_ot_func') ?>" method="POST">
                            ...
                            <button type="submit" class="btn btn-noori" id="add_ot">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
...
<script>
	...
	<?php if($this->session->tempdata('failure')){ ?> 
		Swal.fire({
		icon: 'error',
		title: 'Unable to Add OT, Please Try Again!',
		})
	<?php } ?>
</script>