            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                          ...
                          <li class="sidebar-item dropdown"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fa-solid fa-list"></i></i><span class="hide-menu">Requested</span></a>
                          <ul aria-expanded="false" class="collapse first-level">
                               <li class="nav-small-cap"><i class="mdi mdi-dots-horizontal"></i> <span class="hide-menu">Requested OT</span></li>
                               <li class="sidebar-item mega-dropdown"> <a class="sidebar-link waves-effect waves-dark" href="<?= base_url('manager-requested-ot') ?>" aria-expanded="false"><i class="fa-solid fa-list"></i></i><span class="hide-menu">OT</span></a></li>
                                <li class="nav-small-cap"><i class="mdi mdi-dots-horizontal"></i> <span class="hide-menu">Requested Leave</span></li>
                                <li class="sidebar-item mega-dropdown"> <a class="sidebar-link waves-effect waves-dark" href="<?= base_url('manager-requested-leave') ?>" aria-expanded="false"><i class="fa-solid fa-list"></i></i><span class="hide-menu">Leave</span></a></li>
                           </ul>

                         <li class="nav-small-cap"><i class="mdi mdi-dots-horizontal"></i> <span class="hide-menu">Accepted</span></li>
                         <li class="sidebar-item dropdown"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fa-solid fa-list"></i></i><span class="hide-menu">Accepted</span></a>
                           <ul aria-expanded="false" class="collapse first-level">
                         ...
                         <li class="sidebar-item dropdown"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fa-solid fa-list"></i></i><span class="hide-menu">Rejected</span></a>
                           <ul aria-expanded="false" class="collapse first-level">
