            ...
            <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url(<?= base_url('assets/images/big/auth-bg.jpg) no-repeat center center') ?>;">
                <div class="auth-box">
                    <div id="loginform">
                        ...
                        <h4 class="text-white">Noorisys Technologies</h4>
                        </div>
                    </div>
                        <div class="row">
                            <div class="col-12">
                                <form class="form-horizontal m-t-20" id="loginform" action="<?= base_url('confirm-login') ?>" method="POST">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="email" placeholder="Email" aria-label="Username" required aria-describedby="basic-addon1" required>
                                    </div>
                                    ...
                                    <div class="form-group text-center">
                                        <div class="col-xs-12 p-b-20">
                                            <button class="btn btn-block btn-lg btn-noori" type="submit">Log In</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
<script>
  $("#show_hide_password span").on('click', function(event) {
        ...
        if ($('#show_hide_password input').attr("type") == "text") {
            ...
            $('#show_hide_password i').addClass("mdi-lock");
            $('#show_hide_password i').removeClass("mdi-lock-open");
        } else if ($('#show_hide_password input').attr("type") == "password") {
            $('#show_hide_password input').attr('type', 'text');
            $('#show_hide_password i').removeClass("mdi-lock");
            $('#show_hide_password i').addClass("mdi-lock-open");
        }
    });
</script>