                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-md-flex align-items-center">
                                    <div class="container">
                                        <h2 class="card-title" align="center">Requested OT &nbsp; <span class="badge badge-pill badge-danger"><h4 align="center" style="margin-top: 6px;"><?php foreach($total_hours as $hour){ echo $hour['ot_hours']. " hours";} ?></h4></span></h2>
                                    </div>
                                </div>
							...
							<div class="col-12">
								<form class="mt-4" action="<?=base_url('requested-ot') ?>" method="POST">
									<div class="row">
										...
										<div class="col-3">
											<div class="form-group m-b-30" style="margin-top: 30px;">
												...
												<a href="<?=base_url('requested-ot') ?>" class="btn btn-secondary">Reset</a>
											</div>
										</div>
										...
										<table id="file_export" data-order="[]" class="table v-middle table-hover display wrap">
											...
											<?php foreach($ot_details as $ot){ ?>
												<tr>
													...
													<td><a id="delete" data-id="<?= $ot['id']?>" data-name="<?= $ot['project_name']?>" class="btn btn-danger text-white btn-sm">Delete</a></td>
												</tr>
											<?php } ?>
											</tbody>
                               	 		</table>
...
<script>
	...
	<?php if($this->session->tempdata('delete')){ ?> 
		Swal.fire({
		icon: 'success',
		title: 'Deleted!',
	})
...
<script>
    $(document).on('click', '#delete', function() {
        ...
        Swal.fire({
			title: 'Are you sure?',
			text: "You want to Delete "+name+" OT Request?",
			icon: 'warning',
