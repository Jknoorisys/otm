                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-md-flex align-items-center">
                                    <div class="container">
                                        <h2 class="card-title" align="center">Rejected OT &nbsp; <span class="badge badge-pill badge-danger"><h4 align="center" style="margin-top: 6px;"><?php foreach($total_hours as $hour){ echo $hour['ot_hours']. " hours";} ?></h4></span></h2>
                                    </div>
                                </div>
							...
							<div class="col-12">
								<form class="mt-4" action="<?=base_url('rejected-ot') ?>" method="POST">
									<div class="row">
										...
										<div class="col-3">
											<div class="form-group m-b-30" style="margin-top: 30px;">
												...
												<a href="<?=base_url('rejected-ot') ?>" class="btn btn-secondary">Reset</a>
											</div>
										</div>
